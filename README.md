...
- 入口页采用 283 PRODUCTION 暗色主题，并提供搜索、分类和分页。
- 支持在日志界面重放语音。
...
- 重新设计 283 PRODUCTION 暗色剧情入口页、开始画面和结束画面。
...
- Uses a dark 283 PRODUCTION entry theme with search, category filters, and pagination.
...
- Redesigned the dark 283 PRODUCTION scenario browser, start screen, and end screen.
